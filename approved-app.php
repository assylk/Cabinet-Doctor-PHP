...
<body class="loading"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100"
                                            ...
                                            <tbody>
                                                <?php $sql = mysqli_query($con, "SELECT tblappointment.*,tblappointment.id as id,tblpatient.Name as name, tblpatient.Email, tblpatient.MobileNumber FROM tblappointment INNER JOIN tblpatient ON tblappointment.patientID = tblpatient.patientID where Status='Approved'");
                                                            ...
                                                            <div class="modal-content">
                                                                <div
                                                                    ...
                                                                    <h4 class="modal-title"
                                                                        id="danger-header-modalLabel">Confirm Delete
                                                                    </h4>
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <a href="all-app.php?id=<?php echo $row['id']?>&del=delete"
    ...
    function confirmDelete(userId) {
        if (confirm('Are you sure to delete this user?')) {
            ...
            window.location.href = 'approved-app.php?id=' + userId + '&del=delete';
        }
    }
    </script>
