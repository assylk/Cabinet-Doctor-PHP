...
<body class="loading"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-striped dt-responsive nowrap w-100"
                                            ...
                                            <tbody>
                                                <?php $sql = mysqli_query($con, "SELECT * from tblappointment where patientID is null");
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-app.php?id=<?php echo $row['ID'] ?>&edit=notseen"
                                                            class="action-icon"> <i
    ...
    function confirmDelete(userId) {
        if (confirm('Are you sure to delete this user?')) {
            ...
            window.location.href = 'notseen-app.php?id=' + userId + '&del=delete';
        }
    }
    </script>
