...
<body class="loading"
                    ...
                    <div>
                        <table class="table table-striped table-centered mb-0">
                            ...
                            <tbody>
                                ...
                                <?php 
                                $sql=mysqli_query($con,"SELECT tblpatient.Name as Name,tblpatient.patientID as patientID,tblpatient.id as ID,tblpatient.CIN as CIN,tblappointment.AppointmentDate as AppointmentDate,tblappointment.AppointmentTime as AppointmentTime,tblpatient.CNSS as CNSS,tblpatient.dob as dob from tblpatient inner join tblappointment on tblappointment.patientID=tblpatient.patientID where tblpatient.CIN like '$sdata%' || tblpatient.Name like '$sdata%' order by tblpatient.Name");
                            ...
                            ?>
                                <tr>
                                    <td class="table-user">
                                        <img src="images/patient.png" alt="table-user" class="me-2 rounded-circle" />
                                        <?php echo $row['Name'] ?>
                                    </td>
    ...
    function confirmDelete(userId) {
        if (confirm('Are you sure to delete this user?')) {
            ...
            window.location.href = 'search-app.php?id=' + userId + '&del=delete';
        }
    }
    </script>
</body>
