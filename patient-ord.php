...
$id=$_GET['id'];
$sql=mysqli_query($con,"select * from tblordonnance where patientID='$id'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>CabiNet - Persecription</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">All Patient Prescriptions</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                ...
                                <div class="blog-slider__wrp swiper-wrapper">
                                    ...
                                    <div class="blog-slider__item swiper-slide">
                                        ...
                                        <div class="blog-slider__content">
                                            <span
                                                class="blog-slider__code"><?php echo date('d F Y', strtotime($row['creationDate'])); ?></span>
                                            <div class="blog-slider__title">Perscription Number <?php echo $count ?>
                                            </div>
                                            <div class="blog-slider__text"><?php echo $row['medic']; ?>
                                            </div>
